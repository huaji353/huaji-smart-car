...
//	
//	static uint8 debug_dwon_count = 0;
//	static uint8 uart_dat = 0;
...
//           debug_output(log_str, file, line, NULL);
//		   
//           debug_delay();

//		   if(uart_query_byte(DEBUG_UART_INDEX, &uart_dat))	   
//		   {
//				if(uart_dat == 0x7F)
//				{
//					debug_dwon_count++;
//					if(debug_dwon_count > 2)
//					{
//						IAP_CONTR = 0x60;
//					}
//				}
